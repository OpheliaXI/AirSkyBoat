...
xi.spells.healing.healingTable =
{
    ...
    [xi.magic.spell.WILD_CARROT]    = { { power = 180, maxCap = 150, rate = 1,      constant = 60,  minCap = 12  }, { power = 300, maxCap = 150, rate = 2, constant = 105,  minCap = 12  }, { power = 999, maxCap = 180, rate = 15.6666, constant = 170.43,   minCap = 12  } },
